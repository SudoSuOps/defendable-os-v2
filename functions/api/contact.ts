...
// Resend so it lands at build@swarmandbee.ai — the Resend-verified sender
...
//   CONTACT_FROM_EMAIL  (default: build@swarmandbee.ai · must be on a
...
export const onRequestPost: PagesFunction<Env> = async ({ request, env }) => {
  ...
  const FROM = env.CONTACT_FROM_EMAIL || "DefendableOS <build@swarmandbee.ai>";
